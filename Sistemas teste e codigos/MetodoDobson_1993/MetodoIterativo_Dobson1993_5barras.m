...
warning off;
%% ---- Case Import ---- %%
%%%%Sistema de teste (CARTAO NO FORMATO DO MATPOWER!)
casobase = case5;
...
paramVetor = []; %Vetor de espaço de parâmetros

idx = 1;
while true
    if idx == 1               
       %n0 = [Pd0/norm(Pd0); Qd0/norm(Qd0)];       
       n0 = [0; 0.3513; 0; 0.7160; 0.3570; 0; 0.0055; 0; -0.0326; 0.0074];       
    end
    paramVetor = [paramVetor; [n0(2) n0(7) n0(4) n0(9) n0(5) n0(10)]];
    while true
        it = it + 1;
