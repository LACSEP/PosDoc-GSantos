...
area(1:34) = 1; area(113:115) = 1; area(117) = 1;
area(35:74) = 2;
area(75:112) = 3; area(116) = 3; area(118) = 3;
fpart = [];
...
c = c+1;
B{c}(1:9) = 'EXIC NEWT'; %Fluxo de potência continuado 
